...
class IQFNet(nn.Module):
    def __init__(self,pretrained=False):
        ...
        self.eqm1 = ISQAM(in_channels=24, out_channels=24)
        self.eqm2 = ISQAM(in_channels=40, out_channels=24)
        self.eqm3 = ISQAM(in_channels=112, out_channels=40)
        self.eqm4 = ISQAM(in_channels=160, out_channels=112)

        self.iqm1 = IQFM(in_channels=24, out_channels=48)
        self.iqm2 = IQFM(in_channels=24, out_channels=48)
        self.iqm3 = IQFM(in_channels=40, out_channels=48)
        self.iqm4 = IQFM(in_channels=112, out_channels=112)
        ...
        self.refunet = RefUnet(72 + 1, 64)

    def forward(self, rgb, t, d):
        score_list_t = self.swin1(t)
        score_list_rgb = self.swin1(rgb)
        score_list_d = self.swin1(d)
