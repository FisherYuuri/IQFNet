...
class Mnet(nn.Module):
    def __init__(self,pretrained=False):
        ...
        self.eqm1 = ISQAM(in_channels=256, out_channels=128)
        self.eqm2 = ISQAM(in_channels=512, out_channels=256)
        self.eqm3 = ISQAM(in_channels=1024, out_channels=512)
        self.eqm4 = ISQAM(in_channels=2048, out_channels=1024)

        self.iqm1 = IQFM(in_channels=128, out_channels=64)
        self.iqm2 = IQFM(in_channels=256, out_channels=128)
        self.iqm3 = IQFM(in_channels=512, out_channels=256)
        self.iqm4 = IQFM(in_channels=1024, out_channels=512)
